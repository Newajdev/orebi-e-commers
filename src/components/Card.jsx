    ...
    return (
        <div className='w-[370px] h-[465px] relative  group'>
            ...
            <div className='h-[370px w-full relative'>
                ...
                <div className='bg-white w-full h-[0px] group-hover:h-[156px] duration-500 absolute bottom-0 invisible group-hover:visible py-6 px-8 flex flex-col gap-5 items-end'>
